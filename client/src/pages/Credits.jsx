            ...
            <div key={plan._id} className={`border border-gray-200 dark:border-purple-700 rounded-lg shadow hover:shadow-lg transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ? "bg-purple-50 dark:bg-purple-900" : "bg-white dark:bg-transparent"}`}>
              <div className='flex-1'>
                ...
                <ul>
                  ...
                  <button onClick={()=>toast.promise(purchasePlan(plan._id),{loading:'processing...'})} className='mt-6 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded active:bg-purple-800 transition-colors cursor-pointer'>Buy Now</button>
            </div>
          )})}
      </div>
